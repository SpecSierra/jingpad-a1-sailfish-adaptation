...
SFOS_DISABLE_CELLULAR_STACK := true
SFOS_DISABLE_HWC_GSP := true
TARGET_KERNEL_SOURCE := kernel/jingpad-a1
...
# This board packs dtb.img into boot but does not generate the legacy dt.img.
